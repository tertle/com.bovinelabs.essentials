...
#if UNITY_PHYSICS
namespace BovineLabs.Essentials.Editor
{
    ...
    internal unsafe class ColliderInspector : PropertyInspector<BlobAssetReference<Collider>>
    {
        ...
        public override VisualElement Build()
        {
            ...
            {
                root.Add(CreateDisabled<LongField, long>("Hash", this.Target.m_data.m_Align8Union));
                root.Add(CreateDisabled<Toggle, bool>("RespondsToCollision", this.Target.Value.RespondsToCollision));
